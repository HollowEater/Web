    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p style="color: #666; line-height: 1.6;">
                Cảm ơn bạn đã mua sắm tại Figure Shop.<br>
                Thông tin thanh toán đã được gửi tới Email của bạn.
            </p>
            <hr style="border: 0; border-top: 1px solid #eee; margin: 30px 0;">
            <h3 style="color: #a50064; margin: 0;">QUÉT MÃ MOMO</h3>
            <p style="color: #888; font-size: 13px;">Mở ứng dụng Momo trên điện thoại và quét mã bên dưới</p>
            <div class="momo">
                <img src="../img/momo.jpg" alt="Mã QR Momo"
